 ...
 */
final class Version20240305163941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dividend_payment (id INT AUTO_INCREMENT NOT NULL, stock_entity_id INT DEFAULT NULL, record_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', amount JSON NOT NULL, UNIQUE INDEX UNIQ_1678C3E319B89BB5 (stock_entity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE dividend_payment ADD CONSTRAINT FK_1678C3E319B89BB5 FOREIGN KEY (stock_entity_id) REFERENCES stock (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dividend_payment DROP FOREIGN KEY FK_1678C3E319B89BB5');
