 ...
 */
final class Version20240323223211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dividend_payment (id INT AUTO_INCREMENT NOT NULL, stock_id INT DEFAULT NULL, payout_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', amount JSON NOT NULL, INDEX IDX_1678C3E3DCD6110 (stock_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
