 ...
 */
final class Version20240802131005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exchange_rate (id INT AUTO_INCREMENT NOT NULL, from_currency VARCHAR(3) NOT NULL, to_currency VARCHAR(3) NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', rate JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE portfolio_holding (id INT AUTO_INCREMENT NOT NULL, portfolio_id INT DEFAULT NULL, stock_id INT DEFAULT NULL, number_of_shares NUMERIC(4, 0) NOT NULL COMMENT \'(DC2Type:number_of_shares_type)\', INDEX IDX_D0AF7D8B96B5643 (portfolio_id), INDEX IDX_D0AF7D8DCD6110 (stock_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE portfolio_transaction (id INT AUTO_INCREMENT NOT NULL, portfolio_id INT DEFAULT NULL, holding_id INT DEFAULT NULL, stock_ticker VARCHAR(5) NOT NULL, number_of_shares NUMERIC(4, 0) NOT NULL COMMENT \'(DC2Type:number_of_shares_type)\', price_per_share JSON NOT NULL, transaction_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', transaction_type ENUM(\'BUY\', \'SELL\', \'CLOSE_POSITION\') NOT NULL COMMENT \'(DC2Type:transaction_type)\', INDEX IDX_CC0E3305B96B5643 (portfolio_id), INDEX IDX_CC0E33056CD5FBA3 (holding_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE portfolio_dividend_payment ADD CONSTRAINT FK_EEB1E02EC6E33966 FOREIGN KEY (dividend_id) REFERENCES system_dividend_payment (id)');
